        ...
        <section class="login_area">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo">
                            <img src="img/logo.png" alt="E-learning">
                        </div>
                        <div class="login_form">
                           <h2 style="text-align:center;margin:20px 0;">Learner Login</h2>
                            <form name="form" id="form" class="form-horizontal" enctype="multipart/form-data" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                ...
                                <p style="color:#fff;font-size:16px;">Sign Up <strong><a href="registration.php">Here</a></strong> </p>
                                <p style="color:#fff;font-size:16px;">Lonin for Admin <strong><a href="admin/login.php">Here</a></strong> </p>
                            </form>
                            <p style="margin:20px 0;color:#222;text-align:center;font-size:18px;">Go back to the <strong><a href="index.php">Home</a></strong> </p>
                        </div>
                    </div>
                </div>
            </div>
